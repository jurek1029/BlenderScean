...
void MirrorCube::setModelsManager(ModelsManager* _modelsManager) { modelsManager = _modelsManager; }
void MirrorCube::setCenter(float x, float y, float z) { xCenter = x; yCenter = y; zCenter = z; }
